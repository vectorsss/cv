...
\begin{resumeSubHeadingList}
  \resumeSubheading
    ...
    {项目负责人}{俄罗斯，圣彼得堡}
    \resumeSubSubheading{该项目专注于通过数据治理和有价值的特征/训练数据选择来提高模型性能。}{}
    \resumeSubSubheading{我们通过自研抽样算法，从原始的18亿条无线数据中抽取了6000万条最具代表性的数据。}{}
    \resumeSubSubheading{最终，我们成功地将模型的精度提高了22\%，并去除了20\%的冗余特征，模型训练提速约10\%.}{}
  \resumeSubheading
    {*内部列存储算法}{2023--2024年}
    {研究员}{俄罗斯，圣彼得堡}
  ...
  \resumeSubheading
    ...
    {研究员}{俄罗斯，圣彼得堡} \resumeSubheading {*内部分布式文件存储系统弹性扩展算法}{2023年}
    {研究员}{俄罗斯，圣彼得堡}
  ...
  \resumeSubheading {*数据包/路由数据压缩}{2023年} {研究员}{俄罗斯，圣彼得堡}
