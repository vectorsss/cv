...
\begin{center}
  ...
  \small \email{vector.zhaochi@gmail.com} $|$ \homepage[https://blog.i-ll.cc]{https://blog.i-ll.cc} $|$ \linkedin{https://www.linkedin.com/in/dandanv5} $|$ \github{https://github.com/vectorsss} $|$
...
\begin{resumeSubHeadingList}
  ...
  % \resumeSubheading
  %   {Semi-decentralized of Blockchain Technology}{May 2019 -- Aug. 2019}
  %   {Blockchain Developer}{Yanan, China}
  %   \begin{resumeItemList}
  %     \resumeItem{Implemented the core algorithm of the blockchain.}
  %     \resumeItem{Proposed theoretical improvements on the shortcomings of the current blockchain.}
  %     \resumeItem{Developed a material tracking system based on Semi-decentralized Blockchain.}
  %   \end{resumeItemList}
  ...
  %   \begin{resumeItemList}
  %     \resumeItem{Realized preprocessing of large data under small memory computer conditions.}
  %     \resumeItem{Implemented PCA dimensionality reduction algorithm.}
  %     \resumeItem{Developed Nearest Neighbor Algorithm using Ball-Tree.}
  %   \end{resumeItemList}
  ...
  %   \begin{resumeItemList}
  %     \resumeItem{Developed a web crawler to get Netease News in real time and store it in a database.}
  %     \resumeItem{Implemented Chinese text classification algorithm using CNN.}
  %     \resumeItem{Developed the interaction between the front end and the back end of the project.}
  %   \end{resumeItemList}
...
\begin{resumeSubHeadingList}
  ...
  \begin{resumeItemList}
    ...
    \resumeItem{This project was awarded the provincial \nth{3} prize in the 2018 national computer design competition.}
  \end{resumeItemList}
\end{resumeSubHeadingList}
